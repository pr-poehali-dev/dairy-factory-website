...
const Index = () => {
  ...
  const products = [
    ...
    { name: 'Высокобелковые безлактозные коктейли', description: 'Полезный кисломолочный продукт', icon: 'Droplet' },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Верейский молочный завод работает с 1970 года, обеспечивая население региона качественной молочной продукцией.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
