  ...
  const slides = [
    {
      ...
      subtitle: 'Натуральные молочные продукты',
      content: '10 лет качества, основанного на лучших традициях производства молочной продукции',
    ...
    },
    {
      ...
      content: 'Мы производим качественные молочные продукты, сохраняя традиции и внедряя современные технологии. Наша миссия — обеспечивать каждую семью полезными и вкусными продуктами.',
